...
const ListQuizz = () => {
  ...
  const handleShowDetail = async (quizId) => {
    try {
      ...
      setQuizDetail({
        ...response.data,
        questions_count: response.data.questions
  ...
  const filteredQuizzes = quizzes.filter((quiz) => {
    const matchesSearch = quiz.titre
      .toLowerCase()
      ...
      <Container className="py-4">
                    ...
                    {filteredQuizzes.map((quiz, index) => (
                      <tr key={quiz._id}>
                        ...
                        <td className="align-middle">
                          <Badge
                            bg={getBadgeVariant(quiz.niveau)}
                        ...
                        <td className="align-middle">
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleToggleVisibility(quiz._id, quiz.is_public)
                            }
        ...
        >
          <Modal.Header closeButton className="bg-primary text-white">
            <Modal.Title>📋 Aperçu complet du quiz</Modal.Title>
          </Modal.Header>
          ...
          >
            {quizDetail ? (
              <>
                  ...
                  <div className="d-flex justify-content-between align-items-start">
                    <div>
                      <h4 className="fw-bold text-dark">
                        {quizDetail.quiz.titre}
                      </h4>
                      <p className="text-muted fst-italic">
                        {quizDetail.quiz.description || "Pas de description"}
                      </p>
                    </div>
                    <Badge
                      bg={quizDetail.quiz.isPublic ? "success" : "secondary"}
                      className="fs-6"
                    >
                  ...
                  <div className="d-flex gap-4 mt-3 flex-wrap">
                    ...
                    <div>
                      ...
                      <span className="text-dark">
                        {quizDetail.quiz.user?.prenom}{" "}
                        {quizDetail.quiz.user?.nom}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <h5 className="mb-3 text-primary border-bottom pb-1">
                  🧠 Questions du quiz
                </h5>
