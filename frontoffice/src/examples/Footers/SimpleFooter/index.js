    ...
    <Container>
      ...
      >
        <MKBox
          ...
          fontSize={size.sm}
        >
          &copy; {new Date().getFullYear()},⚠️ Cet espace est réservé aux professeurs et
          administrateurs qui doivent se connecter.
...
SimpleFooter.defaultProps = {
  company: { href: "http://localhost:3000/pages/authentication/sign-in", name: "SenLab-visa" },
  links: [{ href: "http://localhost:3000/pages/authentication/sign-in", name: "Suñu_lab" }],
  light: false,
};
