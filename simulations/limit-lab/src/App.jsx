...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      <button className="voice-btn" onClick={() => speak(explanation)}>
        🔊 Expliquer avec la voix
      </button>
      ...
      <p>
        Exemple : si tu marches vers un mur, même sans toucher le mur,
        on peut dire que ta distance <InlineMath math="d(x)" /> tend vers 0.
      </p>
      ...
      <p>
        ...
        <InlineMath math="x" /> devient très grand.  
        Mais comme l’ordinateur ne peut pas manipuler l’infini,  
        <b>dans cette simulation on prend “∞” ≈ 50</b>.  
        C’est une approximation, mais elle nous aide à comprendre la tendance.
      </p>
